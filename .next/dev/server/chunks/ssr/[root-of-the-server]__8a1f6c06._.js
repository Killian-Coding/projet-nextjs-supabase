...
"[project]/app/actions/tasks.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createTask(formData) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tasks').insert([
        {
            title,
            description,
            status: 'todo'
...
async function getTasks() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tasks').select('*').order('created_at', {
        ascending: false
    });
    if (error) throw error;
    return data;
...
async function updateTaskStatus(id, status) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tasks').update({
        status
    }).eq('id', id);
    if (error) throw error;
    return data;
...
async function deleteTask(id) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tasks').delete().eq('id', id);
    if (error) throw error;
    return data;
}
}),
"[project]/app/TaskForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$tasks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/tasks.ts [app-ssr] (ecmascript)");
...
function TaskForm() {
    ...
    async function handleSubmit(formData) {
        ...
        setError(null);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$tasks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createTask"])(formData);
...
"[project]/app/TaskCard.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TaskCard({ task }) {
    ...
    async function handleStatusChange(newStatus) {
        setIsUpdating(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$tasks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateTaskStatus"])(task.id, newStatus);
        } catch  {
    ...
    async function handleDelete() {
        ...
        setIsDeleting(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$tasks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteTask"])(task.id);
        } catch  {
...
"[project]/app/TaskList.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$TaskCard$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/TaskCard.tsx [app-ssr] (ecmascript)");
'use client';
;
;
function TaskList({ initialTasks }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: initialTasks.map((task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$TaskCard$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                task: task
            }, task.id, false, {
                fileName: "[project]/app/TaskList.tsx",
                lineNumber: 19,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a1f6c06._.js.map